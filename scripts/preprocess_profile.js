...
const RACE_CONFIGS = {
    ...
    giro: {
        ...
        globalLon: 12.5,
        stages: [
            { num: 1,  name: 'Étape 1',  start: 'Nesebăr',            finish: 'Burgas',           date: '09/05/2026' },
            { num: 2,  name: 'Étape 2',  start: 'Burgas',             finish: 'Veliko Tarnovo',   date: '10/05/2026' },
            { num: 3,  name: 'Étape 3',  start: 'Plovdiv',            finish: 'Sofia',            date: '11/05/2026' },
            { num: 4,  name: 'Étape 4',  start: 'Catanzaro',          finish: 'Cosenza',          date: '13/05/2026' },
            { num: 5,  name: 'Étape 5',  start: 'Praia a Mare',       finish: 'Potenza',          date: '14/05/2026' },
            { num: 6,  name: 'Étape 6',  start: 'Paestum',            finish: 'Naples',           date: '15/05/2026' },
            { num: 7,  name: 'Étape 7',  start: 'Formia',             finish: 'Blockhaus',        date: '16/05/2026' },
            { num: 8,  name: 'Étape 8',  start: 'Chieti',             finish: 'Fermo',            date: '17/05/2026' },
            { num: 9,  name: 'Étape 9',  start: 'Cervia',             finish: 'Corno alle Scale', date: '19/05/2026' },
            { num: 10, name: 'Étape 10', start: 'Viareggio',          finish: 'Massa',            date: '20/05/2026' },
            { num: 11, name: 'Étape 11', start: 'Porcari',            finish: 'Chiavari',         date: '21/05/2026' },
            { num: 12, name: 'Étape 12', start: 'Imperia',            finish: 'Novi Ligure',      date: '22/05/2026' },
            { num: 13, name: 'Étape 13', start: 'Alessandria',        finish: 'Verbania',         date: '23/05/2026' },
            { num: 14, name: 'Étape 14', start: 'Aosta',              finish: 'Pila',             date: '26/05/2026' },
            { num: 15, name: 'Étape 15', start: 'Voghera',            finish: 'Milan',            date: '27/05/2026' },
            { num: 16, name: 'Étape 16', start: 'Bellinzona',         finish: 'Carì',             date: '28/05/2026' },
            { num: 17, name: 'Étape 17', start: "Cassano d'Adda",     finish: 'Andalo',           date: '29/05/2026' },
            { num: 18, name: 'Étape 18', start: 'Fai della Paganella',finish: 'Pieve di Soligo',  date: '30/05/2026' },
            { num: 19, name: 'Étape 19', start: 'Feltre',             finish: 'Piani di Pezzè',   date: '31/05/2026' },
            { num: 20, name: 'Étape 20', start: 'Gemona del Friuli',  finish: 'Piancavallo',      date: '01/06/2026' },
            { num: 21, name: 'Étape 21', start: 'Rome',               finish: 'Rome',             date: '02/06/2026' },
        ],
    },
};
...
if (config.gpxMode === 'single') {
    ...
    for (const stageInfo of config.stages) {
        const gpxFile = path.join(config.gpxDir, `etappe-${stageInfo.num}-route.gpx`);
